...
projects[sbsetup][download][branch] = 7.x-4.2.2
...
projects[springboard_themes][download][branch] = 7.x-4.2.2
...
projects[springboard][download][branch] = 7.x-4.2.2-token-failure-hotfix-2
...
projects[encrypt][patch][] = https://raw.github.com/JacksonRiver/Springboard-Build/7.x-4.2.2-token-failure-hotfix-2/patches/encrypt-trim-only-decrypted-output.patch
