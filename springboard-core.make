...
projects[springboard][download][branch] = 7.x-4.2.2-token-failure-hotfix
...
projects[encrypt][patch][] = https://raw.github.com/JacksonRiver/Springboard-Build/7.x-4.2.2-token-failure-hotfix/patches/encrypt-trim-only-decrypted-output.patch
